...
#define __PYX_HAVE___JST
#define __PYX_HAVE_API___JST
/* Early includes */
#include <string.h>
#include <stdlib.h>
#include "gamma.c"
...
static double __pyx_f_4_JST_lgamma(double); /*proto*/
static int __pyx_f_4_JST_searchsorted(double *, int, double); /*proto*/
static double __pyx_f_4_JST__loglikelihood(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, double, double, double, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "_JST"
extern int __pyx_module_is_main__JST;
int __pyx_module_is_main__JST = 0;

/* Implementation of '_JST' */
...
static const char __pyx_k_JST[] = "_JST";
...
static const char __pyx_k_JST_pyx[] = "_JST.pyx";
...
static PyObject *__pyx_kp_s_JST_pyx;
...
static PyObject *__pyx_pf_4_JST__sample_topics(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_nd, __Pyx_memviewslice __pyx_v_ndl, __Pyx_memviewslice __pyx_v_ndlz, __Pyx_memviewslice __pyx_v_nlzw, __Pyx_memviewslice __pyx_v_nlz, __Pyx_memviewslice __pyx_v_alpha_lz, __Pyx_memviewslice __pyx_v_alphasum_l, __Pyx_memviewslice __pyx_v_beta_lzw, __Pyx_memviewslice __pyx_v_betasum_lz, __Pyx_memviewslice __pyx_v_gamma_dl, __Pyx_memviewslice __pyx_v_gammasum_d, __Pyx_memviewslice __pyx_v_DS, __Pyx_memviewslice __pyx_v_WS, __Pyx_memviewslice __pyx_v_LS, __Pyx_memviewslice __pyx_v_ZS, __Pyx_memviewslice __pyx_v_IS, __Pyx_memviewslice __pyx_v_rands); /* proto */
static PyObject *__pyx_pf_4_JST_2_loglikelihood(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_nd, __Pyx_memviewslice __pyx_v_ndl, __Pyx_memviewslice __pyx_v_ndlz, __Pyx_memviewslice __pyx_v_nlzw, __Pyx_memviewslice __pyx_v_nlz, double __pyx_v_alpha, double __pyx_v_beta, double __pyx_v_ga); /* proto */
...
static double __pyx_f_4_JST_lgamma(double __pyx_v_x) {
  double __pyx_r;
 ...
 * 
 */
            __pyx_t_2 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple_, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 16, __pyx_L8_error)
 ...
 */
  ...
  __Pyx_WriteUnraisable("_JST.lgamma", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_r = 0;
  __pyx_L0:;
  #ifdef WITH_THREAD
  __Pyx_PyGILState_Release(__pyx_gilstate_save);
...
static int __pyx_f_4_JST_searchsorted(double *__pyx_v_arr, int __pyx_v_length, double __pyx_v_value) {
  int __pyx_v_imin;
  int __pyx_v_imax;
  int __pyx_v_imid;
  int __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_4_JST_1_sample_topics(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_4_JST_1_sample_topics = {"_sample_topics", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4_JST_1_sample_topics, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_4_JST_1_sample_topics(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_nd,&__pyx_n_s_ndl,&__pyx_n_s_ndlz,&__pyx_n_s_nlzw,&__pyx_n_s_nlz,&__pyx_n_s_alpha_lz,&__pyx_n_s_alphasum_l,&__pyx_n_s_beta_lzw,&__pyx_n_s_betasum_lz,&__pyx_n_s_gamma_dl,&__pyx_n_s_gammasum_d,&__pyx_n_s_DS,&__pyx_n_s_WS,&__pyx_n_s_LS,&__pyx_n_s_ZS,&__pyx_n_s_IS,&__pyx_n_s_rands,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ndl)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("_sample_topics", 1, 17, 17, 1); __PYX_ERR(0, 41, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ndlz)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_sample_topics", 1, 17, 17, 2); __PYX_ERR(0, 41, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_nlzw)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_sample_topics", 1, 17, 17, 3); __PYX_ERR(0, 41, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_nlz)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_sample_topics", 1, 17, 17, 4); __PYX_ERR(0, 41, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_alpha_lz)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_sample_topics", 1, 17, 17, 5); __PYX_ERR(0, 41, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_alphasum_l)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_sample_topics", 1, 17, 17, 6); __PYX_ERR(0, 41, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  7:
        if (likely((values[7] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_beta_lzw)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_sample_topics", 1, 17, 17, 7); __PYX_ERR(0, 41, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  8:
        if (likely((values[8] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_betasum_lz)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_sample_topics", 1, 17, 17, 8); __PYX_ERR(0, 41, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  9:
        if (likely((values[9] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_gamma_dl)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_sample_topics", 1, 17, 17, 9); __PYX_ERR(0, 41, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 10:
        if (likely((values[10] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_gammasum_d)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_sample_topics", 1, 17, 17, 10); __PYX_ERR(0, 41, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 11:
        if (likely((values[11] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_DS)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_sample_topics", 1, 17, 17, 11); __PYX_ERR(0, 41, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 12:
        if (likely((values[12] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_WS)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_sample_topics", 1, 17, 17, 12); __PYX_ERR(0, 41, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 13:
        if (likely((values[13] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_LS)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_sample_topics", 1, 17, 17, 13); __PYX_ERR(0, 41, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 14:
        if (likely((values[14] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ZS)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_sample_topics", 1, 17, 17, 14); __PYX_ERR(0, 41, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 15:
        if (likely((values[15] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_IS)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_sample_topics", 1, 17, 17, 15); __PYX_ERR(0, 41, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 16:
        if (likely((values[16] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_rands)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_sample_topics", 1, 17, 17, 16); __PYX_ERR(0, 41, __pyx_L3_error)
        }
      }
    ...
    __pyx_v_nd = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_nd.memview)) __PYX_ERR(0, 41, __pyx_L3_error)
    __pyx_v_ndl = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_ndl.memview)) __PYX_ERR(0, 41, __pyx_L3_error)
    __pyx_v_ndlz = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_int(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_ndlz.memview)) __PYX_ERR(0, 41, __pyx_L3_error)
    __pyx_v_nlzw = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_int(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_nlzw.memview)) __PYX_ERR(0, 41, __pyx_L3_error)
    __pyx_v_nlz = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(values[4], PyBUF_WRITABLE); if (unlikely(!__pyx_v_nlz.memview)) __PYX_ERR(0, 42, __pyx_L3_error)
    __pyx_v_alpha_lz = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[5], PyBUF_WRITABLE); if (unlikely(!__pyx_v_alpha_lz.memview)) __PYX_ERR(0, 42, __pyx_L3_error)
    __pyx_v_alphasum_l = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[6], PyBUF_WRITABLE); if (unlikely(!__pyx_v_alphasum_l.memview)) __PYX_ERR(0, 42, __pyx_L3_error)
    __pyx_v_beta_lzw = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_double(values[7], PyBUF_WRITABLE); if (unlikely(!__pyx_v_beta_lzw.memview)) __PYX_ERR(0, 43, __pyx_L3_error)
    __pyx_v_betasum_lz = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[8], PyBUF_WRITABLE); if (unlikely(!__pyx_v_betasum_lz.memview)) __PYX_ERR(0, 43, __pyx_L3_error)
    __pyx_v_gamma_dl = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[9], PyBUF_WRITABLE); if (unlikely(!__pyx_v_gamma_dl.memview)) __PYX_ERR(0, 43, __pyx_L3_error)
    __pyx_v_gammasum_d = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[10], PyBUF_WRITABLE); if (unlikely(!__pyx_v_gammasum_d.memview)) __PYX_ERR(0, 44, __pyx_L3_error)
    __pyx_v_DS = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[11], PyBUF_WRITABLE); if (unlikely(!__pyx_v_DS.memview)) __PYX_ERR(0, 44, __pyx_L3_error)
    __pyx_v_WS = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[12], PyBUF_WRITABLE); if (unlikely(!__pyx_v_WS.memview)) __PYX_ERR(0, 44, __pyx_L3_error)
    __pyx_v_LS = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[13], PyBUF_WRITABLE); if (unlikely(!__pyx_v_LS.memview)) __PYX_ERR(0, 44, __pyx_L3_error)
    __pyx_v_ZS = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[14], PyBUF_WRITABLE); if (unlikely(!__pyx_v_ZS.memview)) __PYX_ERR(0, 44, __pyx_L3_error)
    __pyx_v_IS = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[15], PyBUF_WRITABLE); if (unlikely(!__pyx_v_IS.memview)) __PYX_ERR(0, 44, __pyx_L3_error)
    __pyx_v_rands = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[16], PyBUF_WRITABLE); if (unlikely(!__pyx_v_rands.memview)) __PYX_ERR(0, 45, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("_sample_topics", 1, 17, 17, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 41, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("_JST._sample_topics", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4_JST__sample_topics(__pyx_self, __pyx_v_nd, __pyx_v_ndl, __pyx_v_ndlz, __pyx_v_nlzw, __pyx_v_nlz, __pyx_v_alpha_lz, __pyx_v_alphasum_l, __pyx_v_beta_lzw, __pyx_v_betasum_lz, __pyx_v_gamma_dl, __pyx_v_gammasum_d, __pyx_v_DS, __pyx_v_WS, __pyx_v_LS, __pyx_v_ZS, __pyx_v_IS, __pyx_v_rands);
 ...
 *     with nogil:
 */
    __pyx_t_2 = __Pyx_PyObject_Call(__pyx_builtin_MemoryError, __pyx_tuple__2, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 56, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_Raise(__pyx_t_2, 0, 0, 0);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
          ...
          __pyx_v_r = ((*((double *) ( /* dim=0 */ (__pyx_v_rands.data + __pyx_t_35 * __pyx_v_rands.strides[0]) ))) * __pyx_v_dist_cum);
 ...
 *             z_new = res % n_topics
 */
          __pyx_v_res = __pyx_f_4_JST_searchsorted(__pyx_v_dist_sum, (__pyx_v_n_senti * __pyx_v_n_topics), __pyx_v_r);
 ...
 */
          ...
          __pyx_t_1 = (((*((int *) ( /* dim=0 */ (__pyx_v_IS.data + __pyx_t_35 * __pyx_v_IS.strides[0]) ))) == 1) != 0);
          if (__pyx_t_1) {
 ...
 */
          __pyx_t_35 = __pyx_v_i;
          *((int *) ( /* dim=0 */ (__pyx_v_ZS.data + __pyx_t_35 * __pyx_v_ZS.strides[0]) )) = __pyx_v_z_new;
 ...
 */
          __pyx_t_35 = __pyx_v_i;
          *((int *) ( /* dim=0 */ (__pyx_v_LS.data + __pyx_t_35 * __pyx_v_LS.strides[0]) )) = __pyx_v_l_new;
 ...
 */
          __pyx_t_35 = __pyx_v_d;
          (void)((++(*((int *) ( /* dim=0 */ (__pyx_v_nd.data + __pyx_t_35 * __pyx_v_nd.strides[0]) )))));
 ...
 */
          __pyx_t_35 = __pyx_v_d;
          __pyx_t_34 = __pyx_v_l_new;
          (void)((++(*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_ndl.data + __pyx_t_35 * __pyx_v_ndl.strides[0]) ) + __pyx_t_34 * __pyx_v_ndl.strides[1]) )))));
 ...
 */
          __pyx_t_34 = __pyx_v_d;
          __pyx_t_35 = __pyx_v_l_new;
          __pyx_t_33 = __pyx_v_z_new;
          (void)((++(*((int *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_ndlz.data + __pyx_t_34 * __pyx_v_ndlz.strides[0]) ) + __pyx_t_35 * __pyx_v_ndlz.strides[1]) ) + __pyx_t_33 * __pyx_v_ndlz.strides[2]) )))));
 ...
 * 
 */
          __pyx_t_33 = __pyx_v_l_new;
          __pyx_t_35 = __pyx_v_z_new;
          __pyx_t_34 = __pyx_v_w;
          (void)((++(*((int *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_nlzw.data + __pyx_t_33 * __pyx_v_nlzw.strides[0]) ) + __pyx_t_35 * __pyx_v_nlzw.strides[1]) ) + __pyx_t_34 * __pyx_v_nlzw.strides[2]) )))));
 ...
 */
          __pyx_t_34 = __pyx_v_l_new;
          __pyx_t_35 = __pyx_v_z_new;
          (void)((++(*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_nlz.data + __pyx_t_34 * __pyx_v_nlz.strides[0]) ) + __pyx_t_35 * __pyx_v_nlz.strides[1]) )))));
        }
...
static PyObject *__pyx_pw_4_JST_3_loglikelihood(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static double __pyx_f_4_JST__loglikelihood(__Pyx_memviewslice __pyx_v_nd, __Pyx_memviewslice __pyx_v_ndl, __Pyx_memviewslice __pyx_v_ndlz, __Pyx_memviewslice __pyx_v_nlzw, __Pyx_memviewslice __pyx_v_nlz, double __pyx_v_alpha, double __pyx_v_beta, double __pyx_v_ga, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_z;
  int __pyx_v_d;
  int __pyx_v_l;
  int __pyx_v_w;
 ...
 */
        __pyx_v_lgamma_beta = __pyx_f_4_JST_lgamma(__pyx_v_beta);
 ...
 * 
 */
        __pyx_v_lgamma_alpha = __pyx_f_4_JST_lgamma(__pyx_v_alpha);
 ...
 */
        __pyx_v_lgamma_gamma = __pyx_f_4_JST_lgamma(__pyx_v_ga);
 ...
 */
        __pyx_v_ll = (((__pyx_v_n_senti * __pyx_v_n_topics) * __pyx_f_4_JST_lgamma((__pyx_v_beta * __pyx_v_vocab_size))) - (((__pyx_v_n_senti * __pyx_v_n_topics) * __pyx_v_vocab_size) * __pyx_v_lgamma_beta));
 ...
 */
            __pyx_t_7 = __pyx_v_l;
            __pyx_t_8 = __pyx_v_z;
            __pyx_v_ll = (__pyx_v_ll - __pyx_f_4_JST_lgamma(((__pyx_v_beta * __pyx_v_vocab_size) + (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_nlz.data + __pyx_t_7 * __pyx_v_nlz.strides[0]) ) + __pyx_t_8 * __pyx_v_nlz.strides[1]) ))))));
 ...
 */
              ...
              __pyx_v_ll = (__pyx_v_ll + __pyx_f_4_JST_lgamma((__pyx_v_beta + (*((int *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_nlzw.data + __pyx_t_8 * __pyx_v_nlzw.strides[0]) ) + __pyx_t_7 * __pyx_v_nlzw.strides[1]) ) + __pyx_t_12 * __pyx_v_nlzw.strides[2]) ))))));
            }
          }
        }
 ...
 *             for d in xrange(D):
 */
        __pyx_v_ll = (__pyx_v_ll + (((__pyx_v_n_senti * __pyx_v_D) * __pyx_f_4_JST_lgamma((__pyx_v_alpha * __pyx_v_n_topics))) - (((__pyx_v_n_senti * __pyx_v_D) * __pyx_v_n_topics) * __pyx_f_4_JST_lgamma(__pyx_v_alpha))));
 ...
 */
            ...
            __pyx_t_7 = __pyx_v_l;
            __pyx_v_ll = (__pyx_v_ll - __pyx_f_4_JST_lgamma(((__pyx_v_alpha * __pyx_v_n_topics) + (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_ndl.data + __pyx_t_12 * __pyx_v_ndl.strides[0]) ) + __pyx_t_7 * __pyx_v_ndl.strides[1]) ))))));
 ...
 */
              ...
              __pyx_t_12 = __pyx_v_d;
              __pyx_t_8 = __pyx_v_z;
              __pyx_v_ll = (__pyx_v_ll + __pyx_f_4_JST_lgamma((__pyx_v_alpha + (*((int *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_ndlz.data + __pyx_t_7 * __pyx_v_ndlz.strides[0]) ) + __pyx_t_12 * __pyx_v_ndlz.strides[1]) ) + __pyx_t_8 * __pyx_v_ndlz.strides[2]) ))))));
            }
          }
        }
 ...
 */
        __pyx_v_ll = (__pyx_v_ll + ((__pyx_v_D * __pyx_f_4_JST_lgamma((__pyx_v_n_senti * __pyx_v_ga))) - ((__pyx_v_D * __pyx_v_n_senti) * __pyx_v_lgamma_gamma)));
 ...
 */
          __pyx_t_8 = __pyx_v_d;
          __pyx_v_ll = (__pyx_v_ll - __pyx_f_4_JST_lgamma(((__pyx_v_n_senti * __pyx_v_ga) + (*((int *) ( /* dim=0 */ (__pyx_v_nd.data + __pyx_t_8 * __pyx_v_nd.strides[0]) ))))));
 ...
 */
            ...
            __pyx_v_ll = (__pyx_v_ll + __pyx_f_4_JST_lgamma((__pyx_v_ga + (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_ndl.data + __pyx_t_8 * __pyx_v_ndl.strides[0]) ) + __pyx_t_12 * __pyx_v_ndl.strides[1]) ))))));
          }
        }
...
/* Python wrapper */
static PyObject *__pyx_pw_4_JST_3_loglikelihood(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_4_JST_3_loglikelihood(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_nd = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_ndl = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_ndlz = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_nlzw = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  __Pyx_RefNannySetupContext("_loglikelihood (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ndl)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("_loglikelihood", 1, 8, 8, 1); __PYX_ERR(0, 97, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ndlz)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_loglikelihood", 1, 8, 8, 2); __PYX_ERR(0, 97, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_nlzw)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_loglikelihood", 1, 8, 8, 3); __PYX_ERR(0, 97, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_nlz)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_loglikelihood", 1, 8, 8, 4); __PYX_ERR(0, 97, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_alpha)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_loglikelihood", 1, 8, 8, 5); __PYX_ERR(0, 97, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_beta)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_loglikelihood", 1, 8, 8, 6); __PYX_ERR(0, 97, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  7:
        if (likely((values[7] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ga)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_loglikelihood", 1, 8, 8, 7); __PYX_ERR(0, 97, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "_loglikelihood") < 0)) __PYX_ERR(0, 97, __pyx_L3_error)
      }
    ...
    __pyx_v_nd = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_nd.memview)) __PYX_ERR(0, 97, __pyx_L3_error)
    __pyx_v_ndl = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_ndl.memview)) __PYX_ERR(0, 97, __pyx_L3_error)
    __pyx_v_ndlz = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_int(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_ndlz.memview)) __PYX_ERR(0, 97, __pyx_L3_error)
    __pyx_v_nlzw = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_int(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_nlzw.memview)) __PYX_ERR(0, 97, __pyx_L3_error)
    __pyx_v_nlz = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(values[4], PyBUF_WRITABLE); if (unlikely(!__pyx_v_nlz.memview)) __PYX_ERR(0, 98, __pyx_L3_error)
    __pyx_v_alpha = __pyx_PyFloat_AsDouble(values[5]); if (unlikely((__pyx_v_alpha == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 98, __pyx_L3_error)
    __pyx_v_beta = __pyx_PyFloat_AsDouble(values[6]); if (unlikely((__pyx_v_beta == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 98, __pyx_L3_error)
    __pyx_v_ga = __pyx_PyFloat_AsDouble(values[7]); if (unlikely((__pyx_v_ga == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 98, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("_loglikelihood", 1, 8, 8, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 97, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("_JST._loglikelihood", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4_JST_2_loglikelihood(__pyx_self, __pyx_v_nd, __pyx_v_ndl, __pyx_v_ndlz, __pyx_v_nlzw, __pyx_v_nlz, __pyx_v_alpha, __pyx_v_beta, __pyx_v_ga);
...
static PyObject *__pyx_pf_4_JST_2_loglikelihood(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_nd, __Pyx_memviewslice __pyx_v_ndl, __Pyx_memviewslice __pyx_v_ndlz, __Pyx_memviewslice __pyx_v_nlzw, __Pyx_memviewslice __pyx_v_nlz, double __pyx_v_alpha, double __pyx_v_beta, double __pyx_v_ga) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  if (unlikely(!__pyx_v_nd.memview)) { __Pyx_RaiseUnboundLocalError("nd"); __PYX_ERR(0, 97, __pyx_L1_error) }
  if (unlikely(!__pyx_v_ndl.memview)) { __Pyx_RaiseUnboundLocalError("ndl"); __PYX_ERR(0, 97, __pyx_L1_error) }
  if (unlikely(!__pyx_v_ndlz.memview)) { __Pyx_RaiseUnboundLocalError("ndlz"); __PYX_ERR(0, 97, __pyx_L1_error) }
  if (unlikely(!__pyx_v_nlzw.memview)) { __Pyx_RaiseUnboundLocalError("nlzw"); __PYX_ERR(0, 97, __pyx_L1_error) }
  if (unlikely(!__pyx_v_nlz.memview)) { __Pyx_RaiseUnboundLocalError("nlz"); __PYX_ERR(0, 97, __pyx_L1_error) }
  __pyx_t_1 = PyFloat_FromDouble(__pyx_f_4_JST__loglikelihood(__pyx_v_nd, __pyx_v_ndl, __pyx_v_ndlz, __pyx_v_nlzw, __pyx_v_nlz, __pyx_v_alpha, __pyx_v_beta, __pyx_v_ga, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 97, __pyx_L1_error)
...
static PyMethodDef __pyx_methods[] = {
  {"_loglikelihood", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4_JST_3_loglikelihood, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec__JST(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec__JST},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_JST_pyx, __pyx_k_JST_pyx, sizeof(__pyx_k_JST_pyx), 0, 0, 1, 0},
 ...
 * 
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_kp_u_x_must_be_strictly_positive); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 16, __pyx_L1_error)
 ...
 *     with nogil:
 */
  __pyx_tuple__2 = PyTuple_Pack(1, __pyx_kp_u_Could_not_allocate_memory_during); if (unlikely(!__pyx_tuple__2)) __PYX_ERR(0, 56, __pyx_L1_error)
 ...
 *                 double[:, :, :] beta_lzw, double[:, :] betasum_lz, double[:, :] gamma_dl,
 */
  __pyx_tuple__21 = PyTuple_Pack(36, __pyx_n_s_nd, __pyx_n_s_ndl, __pyx_n_s_ndlz, __pyx_n_s_nlzw, __pyx_n_s_nlz, __pyx_n_s_alpha_lz, __pyx_n_s_alphasum_l, __pyx_n_s_beta_lzw, __pyx_n_s_betasum_lz, __pyx_n_s_gamma_dl, __pyx_n_s_gammasum_d, __pyx_n_s_DS, __pyx_n_s_WS, __pyx_n_s_LS, __pyx_n_s_ZS, __pyx_n_s_IS, __pyx_n_s_rands, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_k, __pyx_n_s_w, __pyx_n_s_z, __pyx_n_s_d, __pyx_n_s_l, __pyx_n_s_z_new, __pyx_n_s_l_new, __pyx_n_s_res, __pyx_n_s_r, __pyx_n_s_dist_cum, __pyx_n_s_N, __pyx_n_s_n_rand, __pyx_n_s_n_senti, __pyx_n_s_n_topics, __pyx_n_s_eta_sum, __pyx_n_s_dist_sum, __pyx_n_s_index); if (unlikely(!__pyx_tuple__21)) __PYX_ERR(0, 41, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__21);
  __Pyx_GIVEREF(__pyx_tuple__21);
  __pyx_codeobj__22 = (PyObject*)__Pyx_PyCode_New(17, 0, 36, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__21, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_JST_pyx, __pyx_n_s_sample_topics, 41, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__22)) __PYX_ERR(0, 41, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC init_JST(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC init_JST(void)
#else
__Pyx_PyMODINIT_FUNC PyInit__JST(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit__JST(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec__JST(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module '_JST' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit__JST(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("_JST", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main__JST) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "_JST")) {
      if (unlikely(PyDict_SetItemString(modules, "_JST", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *                 double[:, :, :] beta_lzw, double[:, :] betasum_lz, double[:, :] gamma_dl,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4_JST_1_sample_topics, NULL, __pyx_n_s_JST); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 41, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init _JST", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init _JST");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
